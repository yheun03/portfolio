...
export const works: WorkItem[] = [
    ...
    },
    {
        ...
        points: [
            { ko: '운영 대응력', en: 'Operation responsiveness' },
            { ko: '실서비스 안정성', en: 'Live service stability' },
        ],
    },
    {
        id: 'company-renewal',
        ...
        points: [
            { ko: '브랜딩 사이트 경험', en: 'Branding site experience' },
            { ko: '다국어/SEO 운영 개선', en: 'i18n/SEO operation improvement' },
        ],
    },
    {
        id: 'hanjinkal',
        ...
        points: [
            ...
            { ko: '문서화/협업 역량', en: 'Documentation & collaboration' },
        ],
    },
    {
        id: 'oms',
