export type HomeSectionKey = 'hello' | 'works' | 'about' | 'journey' | 'toolbox' | 'highlights' | 'contact';

/** 헤더 네비·스크롤 스파이와 동일한 섹션 순서 */
export const SCROLL_SECTION_IDS: readonly HomeSectionKey[] = ['hello', 'about', 'works', 'journey', 'toolbox', 'highlights', 'contact'] as const;
