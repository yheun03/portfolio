    ...
    <AppLayout :links="layoutLinks" active-id="" brand-href="/" active-path="/personal"
        ...
        <article class="gallery-detail section gallery-detail--personal">
            ...
            <section class="gallery-detail__captures-section" :aria-label="t('gallery.captures')">
                ...
                <div class="gallery-detail__captures">
                    <figure v-for="(src, index) in work.captures" :key="`${src}-${index}`"
                        ...
                        <img :src="src" :alt="captureAlt(index)" loading="lazy" width="1200" height="675" />
                    </figure>
                </div>
            </section>
            ...
            <p class="gallery-detail__footer-nav">
                <NuxtLink class="base-button base-button--ghost" to="/personal">{{ t("gallery.backToPersonalList") }}
                </NuxtLink>
            </p>
        </article>
    </AppLayout>
...
import { getPersonalWorkById } from "~/core/data/works";
