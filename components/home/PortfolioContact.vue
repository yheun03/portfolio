<template>
    <HomeSection id="contact" section-class="section--contact" title-id="section-contact-title">
        <div class="contact__poster" data-animate="zoom">
            <header class="contact__head">
                <BaseSectionTitle title-id="section-contact-title" :eyebrow="t('nav.contact')"
            ...
            <nav class="contact__actions" :aria-label="t('contact.linksAriaLabel')">
                ...
                <BaseButton :href="profile.contacts.github" :aria-label="t('contact.github')" variant="ghost" external>
                ...
                <BaseButton :href="profile.contacts.resume" :aria-label="t('contact.resume')" variant="ghost" external>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
