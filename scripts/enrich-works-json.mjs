...
const PINNED_CAREER = new Set(['orchem-mes', 'infra', 'company-renewal', 'hanon', 'hanjinkal', 'oms']);
...
function enrichItem(item, personal) {
    ...
    const pin = typeof item.pin === 'boolean' ? item.pin : personal ? PINNED_PERSONAL.has(id) : PINNED_CAREER.has(id);
