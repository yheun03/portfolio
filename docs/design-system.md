...
| -------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `components/Common`  | Base             | `BaseButton`, `BaseBadge`, `BaseCard`, `BaseLabel`, `BaseSectionTitle`, `LanguageToggle`, `ThemeToggle`, `ScrollProgress`, `SectionDock`, `TypoDisplayHeading`               |
...
| `TypoDisplayHeading` | `.typo-word`, section display line classes (e.g. `.hero__display-line`)                | `tag`, `lines`, `groupId`, `headingClass`, `lineClass`, `lineAccentClass`                             | `h1` / `h2` / `h3` heading tag                                   | typo word `Default` / `Active` on hover                     | none         |
