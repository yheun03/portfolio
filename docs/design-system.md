...
| `components/Layout`  | Module / Layout  | `AppLayout`, `AppHeader`, `AppFooter`, `MobileMenu`, `SectionDock`                                                                                                                          |
| `components/Section` | Module / Section | `PortfolioHero`, `PortfolioWorks`, `PortfolioPersonal`, `PortfolioAbout`, `PortfolioJourney`, `PortfolioToolbox`, `PortfolioHighlights`, `PortfolioContact`, `WelcomeCanvas`, `TypoDisplayHeading` |
...
| `SectionDock`         | `.section-dock-ribbon`, `.section-dock`, `.section-dock__item`, `.section-dock__item--active`            | `links: { href; label }[]`, `activeId: string`, `activePath?`                                      | section anchor nav              | item `Default/Active`                                           | none         |
