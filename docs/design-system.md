...
| -------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `components/common`  | Base             | `BaseButton`, `BaseBadge`, `BaseCard`, `BaseLabel`, `BaseSectionTitle`, `LanguageToggle`, `ThemeToggle`, `ScrollProgress`, `SectionDock`                                     |
| `components/Card`    | Pattern / Card   | `WorkCard`, `SkillCard`, `StatCard`, `HighlightCard`, `IntroCard`, `TimelineItem`, `ProjectGalleryCard`                                                                      |
| `components/Layout`  | Module / Layout  | `AppLayout`, `AppHeader`, `AppFooter`, `MobileMenu`                                                                                                                          |
| `components/Section` | Module / Section | `PortfolioHero`, `PortfolioWorks`, `PortfolioPersonal`, `PortfolioAbout`, `PortfolioJourney`, `PortfolioToolbox`, `PortfolioHighlights`, `PortfolioContact`, `WelcomeCanvas` |
...
| `LanguageToggle`   | `.language-toggle`                                                                                                                                                                    | none, uses `useLocale()`                                                                                                        | locale `KO/EN`                                                             | `Default`, `Hover`, `Focus`                                                       | none                          |
| `ThemeToggle`      | `.theme-toggle`                                                                                                                                                                       | none, uses `useTheme()`                                                                                                         | theme `Light/Dark`                                                         | `Default`, `Hover`, `Focus`                                                       | none                          |
| `ScrollProgress`   | `.scroll-progress`                                                                                                                                                                    | none                                                                                                                            | progress transform `scaleX()`                                              | scrolling state                                                                   | none                          |
| `SectionDock`      | `.section-dock`, `.section-dock__item`, `.is-active`                                                                                                                                  | `links: { href; label }[]`, `activeId: string`                                                                                  | item repeated                                                              | `Default`, `Active`                                                               | none                          |

### Card Patterns

| Component            | Class                                                                                  | Props                                                                                                                     | Variants / size                                                  | States                                                      | Slots |
| -------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | ----------------------------------------------------------- | ----- |
| `WorkCard`           | `.work-card`, `.work-card__meta`, `.work-card__tech`, `.work-card__button`             | `work: WorkItem`, `item: { title; type; summary }`, `detailLabel`, `detailAriaLabel?`, `variant?: "career" \| "personal"` | `Career`, `Personal`; label tone changes to `work` or `personal` | `Default`, `Hover` via `data-motion="lift"`; emits `select` | none  |
| `SkillCard`          | `.skill-card`                                                                          | `title`, `items`, `description`                                                                                           | `Toolbox` card pattern                                           | `Default`                                                   | none  |
| `StatCard`           | `.stat-card`, `.stat-card__value`, `.stat-card__label`                                 | `value: number`, `suffix: string`, `label: string`                                                                        | metric card                                                      | `Default`; hero usage can animate count externally          | none  |
| `HighlightCard`      | `.highlight-card`                                                                      | `title`, `items`                                                                                                          | highlight list                                                   | `Default`                                                   | none  |
| `IntroCard`          | `.intro-card`                                                                          | `title`, `description`                                                                                                    | profile principle card                                           | `Default`                                                   | none  |
...
| Component             | Class                                                                                                    | Props                                                                                              | Variants / size                 | States                                                          | Slots        |
| --------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------- | --------------------------------------------------------------- | ------------ |
| `AppLayout`           | `.portfolio-page`, `.portfolio-page--section-dock`                                                       | `links`, `activeId`, `footerText`, `headerLinks?`, `brandHref?`, `activePath?`, `showSectionDock?` | section dock `Shown/Hidden`     | page layout state                                               | default slot |
| `AppHeader`           | `.app-header`, `.app-header__brand`, `.app-header__nav`, `.app-header__actions`, `.app-header__menu-btn` | `links`, `activeId`, `brandHref?`, `activePath?`                                                   | desktop nav, mobile menu button | nav item `Default/Active`; menu `Open/Closed`                   | none         |
| `MobileMenu`          | `.mobile-menu`, `.mobile-menu__backdrop`, `.mobile-menu__eyebrow`                                        | `id?`, `open`, `links`, `activeId?`, `activePath?`                                                 | drawer `Open/Closed`            | link `Default/Active`; emits `close`                            | none         |
...
| `PortfolioHero`       | `.section--hero`, `.hero__poster`, `.hero__actions`, `.hero__metric-strip`                               | none, uses site data                                                                               | hero composition                | stat count-up on intersection                                   | none         |
...
| `WelcomeCanvas`       | `.area-welcome`, `#animatedCanvas`                                                                       | none                                                                                               | animated canvas                 | continuous animation                                            | none         |
...
| `ui-tab-button`      | `Tab / Pill / Default`, `Tab / Pill / Active`, `Tab / LNB / Default`, `Tab / LNB / Active`                    |
| `WorkCard`           | `Card / Work / Career`, `Card / Work / Personal`                                                              |
| `SkillCard`          | `Card / Skill / Toolbox`                                                                                      |
| `StatCard`           | `Card / Stat / Default`                                                                                       |
| `HighlightCard`      | `Card / Highlight / Default`                                                                                  |
| `IntroCard`          | `Card / Intro / Profile`                                                                                      |
...
| `MobileMenu`         | `Navigation / Mobile Menu / Open`, `Navigation / Mobile Menu / Closed`                                        |
| `SectionDock`        | `Navigation / Section Dock / Default`, `Navigation / Section Dock / Active`                                   |
