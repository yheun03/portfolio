...
import { defineComponent, watch, ref, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, toRef, isRef, useSSRContext } from 'vue';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "area-information" }, _attrs))}><div class="content"><h2>\uC81C\uAC00 \uC81C\uC77C<br>\uC798\uD558\uB294 \uC77C\uC744<br>\uC18C\uAC1C\uD569\uB2C8\uB2E4 \u{1F44F}</h2><ul><!--[-->`);
